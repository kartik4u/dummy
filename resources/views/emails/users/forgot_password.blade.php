                                  ...
                                  <td><table width="560" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner">
                                      ...
                                      <tr>
                                         ...
                                         <tr>
                                            ...
                                            <a href="{{ config('variable.SERVER_URL') }}/reset-password/<?php echo $data['forgot_password']; ?>" style="color: #00bbcc;">Reset Password</a>
                                            </td>
                                        </tr>
                                  ...
                                  <td><table width="560" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner">
                                      ...
                                      <tr>
                                          <td style="font-family: Open Sans,open-sans,sans-serif; font-size:14px; line-height:22px; vertical-align: top; color:#00bbcc; ">
                                              <a style="color:#00bbcc" href="{{ config('variable.SERVER_URL') }}/reset-password/<?php echo $data['forgot_password']; ?>">{{ config('variable.SERVER_URL') }}/reset-password/<?php echo $data['forgot_password']; ?></a>
                                          </td>
                                        </tr>
                                      <tr>
