...
<!-- Breadcrumb -->
<ol class="breadcrumb">
  <li class="breadcrumb-item active"><a href="{{ route('admin.reportedchallenges.list') }}">{{ $title }}</a></li>
    <li class="breadcrumb-item active">{{ $challenge->challenge->name }}</li>
...
@endif
 ...
 <div class="col-md-6 text-right">
                ...
                <a class="u_status_single" data-user_id="{{ $challenge->user_id }}" data-id="{{ $challenge->id }}" data-status="2"  href="javascript:void(0);" >
                  <span class="btn btn-danger mt-0" >Deactivate</span></a>
                  @else
                  <a class="u_status_single" data-user_id="{{ $challenge->user_id }}" data-id="{{ $challenge->id }}" data-status="1"  href="javascript:void(0);" >
                    <span class="btn btn-success mt-0" >Activate</span></a>
                @endif
        ...
        <div class="user-mangement-list">
              ...
              <div class="data-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="text-center">{{ $user->reportedFrom->name }}</td>
