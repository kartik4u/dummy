...
@endif
 ...
 <div class="col-md-6 text-right">
                ...
                <a class="u_status_single" data-id="{{ $user->id }}" data-status="1"  href="javascript:void(0);" >
                  ...
                  @else
                  <a class="u_status_single" data-id="{{ $user->id }}" data-status="0"  href="javascript:void(0);" >
        ...
        <div class="user-mangement-list">
              ...
              <div class="data-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="text-center">{{ $user->reportedByUser->first_name }} {{ $user->reportedByUser->last_name }}</td>
