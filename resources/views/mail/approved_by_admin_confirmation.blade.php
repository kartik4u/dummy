...
<table width="100%" cellpadding="0" cellspacing="0" border="0" id="backgroundTable">
 ...
 ?>" target="_blank"><img src="{{ URL::asset('/images/white-logo.png') }}" alt="logo" class="logo" style="max-width: 140px;" /></a>
                                 </td>
                              </tr>
                             <tr>
                              <td height="50"></td>
                                       ...
                                       <tbody>
                                        ...
                                        <tr>
                                            <td class="scale-center">
                                                ...
                                                <font style="font-family:Helvetica, Arial, sans-serif; font-size: 15px; color: #00758e; font-weight:600;">Congratulations <?php echo isset($first_name) ? ucfirst($first_name) : '' ?>,</font>
                                        ...
                                        <tr>
                                            <td style="line-height: 30px;" class="scale-center-both">
                                                ...
                                                <font style="font-family:Helvetica, Arial, sans-serif; line-height: 26px; font-size:14px; color:#000000;">Your account has been approved by admin. Now you can login and access your account. Thank You for choosing our platform. <br/><br/></font>
                                        ...
                                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;text-align: center;">
                                          ...
                                          <br>
                                          <a href="<?php echo $frontend_url ; ?>" style="font-family:Helvetica, Arial, sans-serif; line-height: 26px; font-size:16px; color:#fff;background: #01758e;padding:16px;display: inline-block;text-decoration: none;"><?php echo $frontend_url ; ?></a><br></p>
                                        </td>
                                        </tr>
                                        <tr>
                                            <td height="20"></td>
