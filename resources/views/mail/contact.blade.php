...
<td class="scale-center">
    <p style="font-family:Helvetica, Arial, sans-serif; font-size:15px; color: #00bbcc; line-height:2; font-style:italic; font-weight:600;">Thank You,<br/>Yourfut Team.</p>
</td>
</tr>
    ...
    <tbody>
      <tr>
        <td style="width: 50%; text-align: left;">
          <p style="font-size: 14px;">Copyright©Yourfut. All rights reserved.</p>
        </td>
