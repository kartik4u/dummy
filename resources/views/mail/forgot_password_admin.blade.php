                        ...
                        <table bgcolor="#ffffff" width="600" align="center" cellspacing="0" cellpadding="0" border="0" class="devicewidth" style="background: #00758e;">
                           <tbody>
                            <tr>
                              ...
                              <tr>
                                 <td align="center">                                    
                                    <a style="text-decortation:none;display: inline-block;width: 100%;text-align: center;" href= "<?php echo $site_url =  \Config::get('variable.FRONTEND_URL'); ?>" target="_blank"><img src="{{ asset('assets/img/email_logo.png') }}" alt="logo" class="logo" style="max-width: 140px;" /></a>
                                 </td>
                              </tr>
                              <tr>
                                <td height="50"></td>
                                       ...
                                       <tbody>
                                        ...
                                        <tr>
                                            <td class="scale-center">
                                                ...
                                                <font style="font-family:Helvetica, Arial, sans-serif; font-size: 15px; color: #00758e; font-weight:600;">Hi {{ $name }},</font>
                                        ...
                                        <tr>
                                            <td style="line-height: 30px;" class="scale-center-both">
                                                ...
                                                <font style="font-family:Helvetica, Arial, sans-serif; line-height: 26px; font-size:14px; color:#000000;">You are receiving this email because we received a password reset request for your account.<br/><br/>Please click on the link below to reset your password.</font>
                                        ...
                                        <tr>
                                            <td style="line-height: 30px;text-align: center;" class="scale-center-both">
                                                <a href="<?php echo $admin_url . 'reset-password/' . $forgot_password_token; ?>" target="_self" style="color: #fff;background: #00758e;display: inline-block;padding:16px;text-decoration: none;">
                                                    Click Here
                                                </a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="line-height: 30px;" class="scale-center-both">
                                                ...
                                                <a href="javascript:void(0);" style="font-family:Helvetica, Arial, sans-serif; line-height: 26px; font-size:16px; color:#00758e;text-decoration: none;"><?php echo $admin_url . 'reset-password/' . $forgot_password_token; ?></a>
                                                    ...
                                                    <tbody> 
                                                        <tr>
                                                            <td style="width: 50%; text-align: left;">
                                                             <p style="font-size: 14px;color:#FFFFFF;">Copyright©Carebe. All rights reserved.</p>
                                                            </td>
