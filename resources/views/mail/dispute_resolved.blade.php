                                       ...
                                       <tbody>
                                        ...
                                        <tr>
                                            <td style="line-height: 30px;" class="scale-center-both">
                                              <br>
                                              <font style="font-family:Helvetica, Arial, sans-serif; line-height: 26px; font-size:14px; color:#000000;"> Dispute has been resolved by admin for the job <span style="font-family:Helvetica, Arial, sans-serif;font-size:15px;color:#00758e;font-weight:600;"><?php echo $invite_data['title'] ?></span>, following detail: <br/><br/></font>
