                                       ...
                                       <tbody>
                                        ...
                                        <tr>
                                            <td style="line-height: 30px;" class="scale-center-both">
                                              <br>
                                              <font style="font-family:Helvetica, Arial, sans-serif; line-height: 26px; font-size:14px; color:#000000;">Your profile has been rejected due to following reason: <br/><br/></font>
