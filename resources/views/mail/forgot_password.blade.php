                                       ...
                                       <tbody>
                                        ...
                                        <tr>
                                            <td class="scale-center">
                                                <font style="font-family:Helvetica, Arial, sans-serif; font-size: 15px; color: #00758e; font-weight:600;">Hi <?php isset($name)?$name:''; ?>,</font>
                                        ...
                                        <tr>
                                          ...
                                          <tr>
                                            <td style="line-height: 30px; text-align: center;" class="scale-center-both">
                                              <a href="<?php echo $data['frontend_url']; ?>user/resetpassword/<?php echo $data['forgot_password']; ?>" style="color: #fff;background: #00758e;display: inline-block;padding:16px;text-decoration: none;">
                                                  Click Here
                                              </a>
                                            </td>
                                          </tr>
                                        ...
                                        <tr>
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 18px; color:#00758e; line-height: 24px;">
                                                <?php echo $data['frontend_url']; ?>user/resetpassword/<?php echo $data['forgot_password']; ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="20"></td>
                                        ...
                                        <tr>
                                          <td style="border-bottom: 1px solid #d6d6d5;" height="54"></td>
                                        </tr>
                                       </tbody>
                                    </table>
                                 </td>
                                                    ...
                                                    <tbody> 
                                                        <tr>
                                                            <td style="width: 50%; text-align: left;">
                                                             <p style="font-size: 14px;color:white">Copyright©Carebe. All rights reserved.</p>
                                                            </td>
